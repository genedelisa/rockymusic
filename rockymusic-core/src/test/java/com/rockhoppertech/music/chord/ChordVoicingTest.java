...
public class ChordVoicingTest {
	...
	public void testGetInversion() {
		...
		assertNotNull(c);
		assertNotNull(c2);
		System.err.println(System.identityHashCode(c.getChordVoicing()));
		System.err.println(System.identityHashCode(c2.getChordVoicing()));
