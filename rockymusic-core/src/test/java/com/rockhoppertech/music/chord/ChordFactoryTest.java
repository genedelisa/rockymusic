...
public class ChordFactoryTest {
    ...
    /**
     * The ChordFactory will throw and catch an UnknownChordException.
     * It will create a new Chord on the fly.
     */
    @Test
    public void getWTFChordSymbols() {
        String[] symbols = null;
        Scale scale = null;
    ...
    public void getSeventhChords() {
        ...
        assertThat("chords are not null",
                chords, is(notNullValue()));
        for (Chord c : chords) {
            logger.debug(c.getDisplayName());
        }
        assertThat(
                "display name is correct",
                chords[0].getDisplayName(),
                equalTo("Cmaj7"));
        assertThat(
                "display name is correct",
                chords[1].getDisplayName(),
                equalTo("Dm7"));
        assertThat(
                "display name is correct",
                chords[2].getDisplayName(),
                equalTo("Em7"));
        assertThat(
                "display name is correct",
                chords[3].getDisplayName(),
                equalTo("Fmaj7"));
        assertThat(
                "display name is correct",
                chords[4].getDisplayName(),
                equalTo("G7"));
        assertThat(
                "display name is correct",
                chords[5].getDisplayName(),
                equalTo("Am7"));
        assertThat(
                "display name is correct",
                chords[6].getDisplayName(),
                equalTo("Bm7-5"));

        scale = ScaleFactory.createFromName("Harmonic Minor");
        assertThat("scale not null",
    ...
    public void getChordsAllTo13() {
        ...
        assertThat(
                "the thirteenth is correct",
                thirteenth,
                equalTo(PitchFactory
    ...
    public void getChordsAllTo7() {
        Scale scale = ScaleFactory.createFromName("Major");
        assertThat("Scale is not null", scale, notNullValue());
        Chord[] chords = ChordFactory.getChords(
                scale,
                true,
                false,
                false,
