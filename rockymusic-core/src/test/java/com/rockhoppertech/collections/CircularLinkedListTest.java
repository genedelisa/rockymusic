...
public class CircularLinkedListTest {
    private static final Logger logger = LoggerFactory
            .getLogger(CircularLinkedListTest.class);
    ...
    @Test
    public void testCircularLinkedListCollectionOfQextendsE() {
        List<Integer> orig = Lists.newArrayList(1, 2, 3);
        List<Integer> list = new CircularLinkedList<Integer>(orig);
...
//    @Test
//    public void testCircularLinkedListEArray() {
//        Integer[] a = new Integer[] { 1, 2, 3 };
//        List<Integer> list = new CircularLinkedList<Integer>(a);
//        assertThat("list is not null",
//                list,
//                notNullValue());
//        assertThat("list length is correct",
...
//    @Test
//    public void testCircularLinkedListInt() {
//        // initial capacity
//        List<Integer> list = new CircularLinkedList<Integer>(5);
//        assertThat("list is not null",
//                list,
//                notNullValue());
//    }
    ...
    public void testIsFirst() {
        Integer[] a = new Integer[] { 1, 2, 3 };
        CircularLinkedList<Integer> list = new CircularLinkedList<Integer>(a);
        logger.debug("the list:\n{}", list);
