...
/**
 * Partial implementation of the MIDINoteModifier interface.
 * 
 * @author <a href="mailto:gene@rockhoppertech.com">Gene De Lisa</a>
 * 
 */
public abstract class AbstractMIDINoteModifier implements MIDINoteModifier {
    ...
    protected MIDINoteModifier successor;

    public AbstractMIDINoteModifier() {
    ...
    public AbstractMIDINoteModifier(final Number... numbers) {
        this(Operation.SET, numbers);
    }

    public AbstractMIDINoteModifier(final Operation op,
    ...
    public AbstractMIDINoteModifier(final List<Number> list) {
     ...
     */
    public MIDINoteModifier getSuccessor() {
        return successor;
    }
}
