 ...
 * 
 */
public class InputStaffApp extends Application {

    private static final Logger logger = LoggerFactory
            .getLogger(InputStaffApp.class);
    private Stage stage;
    private Scene scene;
    private Pane root;
    ...
    void loadRootFxml() {
        String fxmlFile = "/fxml/InputStaffPanel.fxml";
        logger.debug("Loading FXML for main view from: {}", fxmlFile);
        try {
            FXMLLoader loader = new FXMLLoader(
                    InputStaffApp.class.getResource(fxmlFile));
    ...
    public void start(Stage stage) throws Exception {
        ...
        this.scene = SceneBuilder.create()
                ...
                .stylesheets("/styles/inputStaffApp.css")
                .build();
        this.configureStage();
